...
const NonGamingOffersCarousel = ({ offers = [], className = "" }) => {
    ...
    if (offers.length === 0) {
        return (
            <div className={`w-full max-w-[335px] h-[255px] mx-auto flex flex-col items-center justify-center ${className}`}>
    ...
    return (
      ...
      */}
            <div className="relative w-full flex justify-center h-[220px] overflow-hidden">
